...
/*
void factor_base_creation(unsigned B){

}

unsigned compute_B(mpz_class& number){
...
int main(){
    std::string number = "160769357899975610828199539114109518167531134514190990785144666932076614717841";
